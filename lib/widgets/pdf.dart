    ...
    Page(
      ...
      build: (context) {
        ...
        return Container(
          ...
          height: m.MediaQuery.of(c).size.height * .28,
          child: Column(
            children: [
                          SizedBox(height: 3),
            ...
            Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("مسلسل التذكره :${record.wightTecket_serial}",
                        style: s, textDirection: TextDirection.rtl),
                  ),
                ].reversed.toList()),
            Row(
...
///////////////////////////////////////////////////////////////////////////////////////////           
            ...
            Table(
              ...
              children: [
               ...
               record.actions.if_action_exist(WhigtTecketAction.create_fristWhight.getTitle)==false?SizedBox() :  Container(
                      padding: const EdgeInsets.all(5),
                      child: Center(
                          child: Text(
            ...
            Table(
             ...
             record.actions.if_action_exist(WhigtTecketAction.create_secondWhigt.getTitle)==false?SizedBox():       Container(
                      padding: const EdgeInsets.all(5),
                      child: Center(
                          child: Text(
            ...
            Container(
                ...
                child: Center(
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                      Text("                  صافى الوزن  :${record.totalWeight.toStringAsFixed(0)}                ",
                          style: TextStyle(
                              font: font,
                              fontSize: 18,
                              fontWeight: FontWeight.bold),
